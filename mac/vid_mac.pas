...
uses
  ...
  {$IFDEF MSWINDOWS}
  snd_win,   // Windows-specific sound
  in_win,    // Windows input
  sys_win,   // Windows system
  {$ENDIF}

  {$IFDEF LINUX}
  snd_sdl,   // SDL-based sound (Linux)
  in_linux,  // Linux input
  sys_linux, // Linux system
  {$ENDIF}

  {$IFDEF DARWIN}
  snd_mac,   // macOS-specific sound
  in_mac,    // macOS input
  sys_mac,   // macOS system
  {$ENDIF}
